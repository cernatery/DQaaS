...
**Case:** Název sady několika testů, může být jakýkoli, například název tabulky, pro kterou budeme tvořit více samostatných testů. <br>
**First Data Source:** Název (alias) databáze nebo jiného zdroje, ve kterém bude exekuována query. Jedná se o ConnectionName, které jsme si definovali. <br>
**First Query:** Samotná query/dotaz do databáze nebo jiného zdroje. <br>
**Expectation:** Pro Smoke testy v tomto případě používáme **Set is Empty**. U Set Is Empty CAT očekává, že se nám nevrátí žádné hodnoty po exekuci query/dotazu. Pokud se nějaká hodnota vrátí, test spadne.
